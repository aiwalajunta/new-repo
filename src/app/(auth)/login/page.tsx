          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 space-y-4">
            <div>
              ...
              <div className="mt-2 rounded-xl bg-amber-50 border border-amber-200 p-3 text-xs space-y-1">
                ...
                <p className="text-amber-700">
                  \ud83d\udc51 Owner: <code className="rounded bg-amber-100 px-1 font-mono">owner@adityatextile.com</code> /{" "}
                  <code className="rounded bg-amber-100 px-1 font-mono">owner123</code>
                </p>
                <p className="text-amber-700">
                  \ud83d\udc77 Staff: <code className="rounded bg-amber-100 px-1 font-mono">staff@adityatextile.com</code> /{" "}
                  <code className="rounded bg-amber-100 px-1 font-mono">staff123</code>
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleStaffLogin} className="space-y-3">
              <div className="relative">
                ...
                <Input
                  type="email"
                  placeholder="owner@adityatextile.com"
                  className="pl-9"
                  value={form.email}
        ...
        {tab === "customer" && (
          <div className="rounded-2xl border border-gray-200 bg-white p-5 space-y-4">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">Enter phone number to receive OTP</p>
              <div className="mt-2 rounded-xl bg-amber-50 border border-amber-200 p-2 text-xs text-amber-700">
                Demo: use any phone + OTP <code className="font-mono font-bold">123456</code>
              </div>
            </div>
